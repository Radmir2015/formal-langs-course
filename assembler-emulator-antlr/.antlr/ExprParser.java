// Generated from d:\Документы\Задания от ВУЗа\3 курс\1 семестр\ТАиФЯ\assember-emulator-antlr\Expr.g4 by ANTLR 4.7.1
	...
	public final StatContext stat() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				setState(5);
				match(NEWLINE);
				print(((StatContext)_localctx).e.v);
				}
				break;
			case 2:
				...
				setState(11);
				match(NEWLINE);
				self.memory[(((StatContext)_localctx).ID!=null?((StatContext)_localctx).ID.getText():null)] = ((StatContext)_localctx).e.v
				}
				break;
			case 3:
	...
	private EContext e(int _p) throws RecognitionException {
		...
		try {
			...
			case ID:
				...
				id = (((EContext)_localctx).ID!=null?((EContext)_localctx).ID.getText():null)
				_localctx.v = self.memory.get(id, 0)
			...
			case T__1:
				...
				setState(24);
				match(T__2);
				_localctx.v = ((EContext)_localctx).e.v
				}
				break;
			default:
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_localctx.v = self.eval(((EContext)_localctx).a.v, ((EContext)_localctx).op, ((EContext)_localctx).b.v)
						}
						break;
					case 2:
						{
